...
"Glaskatch": {
    ...
    <em style="color: #555;">"It was the weirdest date of my life. I think she was wearing a 'Witty' shard that had belonged to an old man...? She kept cracking jokes about the price of wool and calling me 'sonny'. I wasn't sure if she was flirting or vetting me for her bridge club."</em><br>
		...
		<img src="assets/Glaskatch_map.jpg" style="width:100%; cursor:zoom-in;" onclick="showLightbox('assets/Glaskatch_map.jpg')">
    ...
    `
		...
		<em style="color: #555;">I have reviewed your report regarding the bedrock density in Sector 4. You claim the stone is too hard to drill on schedule. Let me remind you where you stand, and what your contractual obligation is. I  do not care if you have to melt the granite or break every drill-bit in your inventory. We have a contract with the Ledgerwind to open that tunnel by the solstice. Fix the gradient, Vask, your excuses and geological condition are of no interest to me.</em><br>
            ...
            Haldrith is a region defined by the grind. It is an industrious highland where the terrain itself seems to have been bullied into submission by centuries of construction. There is no inherited nobility here, and certainly no patience for idle hands. It is a society held together by the ink of a thousand contracts and the sweat of its guilds.<br>
    ...
    "molakar": {
        ...
        "content": `
            ...
            Molakar is a thermal shocked desert. It is a vast, arid expanse where the sun beats down on dunes that sit right alongside deep, permanent scars of intense cold known as Molakar Veins. These deep, crystalline valleys, where the temperature sits permanently below freezing, cut through the burning sands like blue arteries. But the air between the heat and the cold is never still. The clash of temperatures creates a volatile atmosphere. "Thermal Gales" erupt with little warning, blasting the dunes with freezing winds that can turn a man to ice mid-stride. Hailstorms strike regardless of the season, shattering glass and bone alike. Even the ground is unstable; a dune might bake in the sun all day, only to flash-freeze into a rigid, slippery mountain of ice at night, then melt into a treacherous slurry by dawn.<br>
    ...
    "kelarra_peaks": {
        ...
        "content": `
            ...
            Kelarra is a loose confederation of independent city-states, bound together only by the Halcyon League. Because the League controls the banking and the mail, they are the de facto arbiters of the peaks. However, the day-to-day rule is meritocratic. Towns are often run by the Engineers who maintain the Anchors or the Masters of the local Monasteries. It is a society of voluntarism. If you don't like the rules of one peak, you can simply glide to another. This has bred a culture of fierce independence and hospitality. You don't turn away a traveler in Kelarra, because tomorrow, the wind might shift, and  you  might be the one knocking on a door.<br><br>
             ...
             <h4 style="color: #000080; margin-bottom: 3px;">Architecture</h4>
             ...
             <h4 style="color: #000080; margin-bottom: 3px;">Demographics</h4>
             The population is a mix of those born to the sky and those who sought to escape the world below. Humans and Elves are the most common residents, often adapted with glider-suits and lung-training. There is also a significant population of Myrrkin who migrated from the nearby Myrskov woods, finding the dreamlike logic of the drifting peaks comforting. Varn are also common here. While the peaks are magical, the altitude lifts them above the "polluted" arcane static of the war-torn lowlands. For a Varn, the magic here feels clean, humming with a pure resonance rather than the jagged noise of the south.<br><br>
...
<em style="color: #555;">"I have a rock here from Haldrith. Look at it. Jagged. Sharp. Unbalanced. Hold it. Feels good, doesn't it? It’s yours for 50 silver. Just don't let your father see you holding that."</em><br>
            ...
            Tavernash is a land of unnatural serenity. Geographically, it is a flat, expansive peninsula where the laws of aerodynamics and gravity are artificially smoothed by the  Gyre-Stone . Without this massive monolith of the old age at the island's center, the region would quickly sink under the tides. In Tavernash, the wind does not blow; it quietly hums. The sea does not crash; it laps against the shore in a perfect, calm rhythm. This physical stillness has birthed a culture of deep, philosophical detachment. The land actively resists chaos and change. To shout in Tavernash is not just rude, it feels physically difficult. As if the air itself resists the discord. While the coastal, working folk bear their burdens with a disciplined quiet, the nobility here have transcended urgency entirely, drifting through the plazas in a state of chemically induced serenity.<br><br>

            <h4 style="color: #000080; margin-bottom: 3px;">The Kenosis</h4>
            The Kenosis - "The Great Emptying", is the anchor of Tavernashi culture. The state religion teaches that emotion is a chaotic tether that binds the soul to the suffering of the material world. To be "Holy" is to be detached - to observe the world without reacting to it. To achieve this state, the nobility and clergy partake in the  Sacrament of Nareth . A tea brewed from the sap of the Ringwood trees. It is a potent narcotic that does not induce a "high," but rather a profound, lucid impersonality. It dissolves anxiety, ambition, and rage, leaving behind a cool, functional logic. A rigid tradition of inheritance dictates class, which grants the privilege of the Sacrament . The Absolved  (the nobility) take the Sacrament daily, existing in a state of holy, velvet numbness. They speak slowly, move gracefully, and view panic as a vulgarity.  The Tethered  (the commoners) consume very little. They are mostly kelp-farmers and fishermen living on the coast, too busy feeding the nation to be "Enlightened." They bear the burden of emotion with grim pride, viewing their rulers not as oppressors, but as holy martyrs who sacrifice their humanity to maintain the kingdom’s delicate balance.<br><br>
            ...
            <h4 style="color: #000080; margin-bottom: 3px;">Plot Hooks</h4>
            &bull; <strong>The Gyre-Wobble:</strong> During a high-society gala, the Gyre-Stone stutters. For ten seconds, the repression of the ocean fails. Seawater erupts from the drains and surges over the sea-walls, flooding the lower plaza of Aretzu with waist-deep brine before instantly receding when the Stone stabilizes. The King hires the party to journey into the mechanism beneath Aretzu to find the "discordant gear" before the capital is swallowed by the sea.<br>
...
"Myrskov": {
        ...
        "content": `
           <em style="color: #555;">"You're walking too loud." "I barely made a sound." "It’s not about the twigs. It’s the intent. If you march through like a soldier, the woods will treat you like one." "So how should I walk then?""You have to walk like who you are, not like the role you were assigned. Do that, and the mist might just let you pass."</em><br>
            ...
            Myrskov is a region of double-vision. To the naked eye, it is a damp boreal forest, heavy with ancient pines and clinging mist. But to the mind, it is something else entirely. The air feels thick, charged with unplaced nostalgia. It is a place where a second, dreamlike reality sits heavily on top of the physical world. This is not a trap for the unwary, but a test of the spirit. A pragmatic traveler might cross Myrskov and see nothing but trees and fog. But for the sensitive or the open-hearted, the forest induces a state of child-like wonder, a feeling of returning to a home one has never visited. The danger here is not getting lost in the geography, but drifting too far into this feeling of "oneness," forgetting the urgency of the waking world. Despite this, while not heavily populated, the region is mostly stable. Some villages thrive, maintained by the  Listeners . These local guardians patrol the "Chime Routes" - ancient paths marked by iron bells and bone wind chimes. They train to listen for the subtle discord in the wind that signals a Rift opening or the dream-layer growing too thick.<br><br>
    ...
    "downsview": {
        "title": "Downsview",
        "type": "town",
        "image": "assets/Downsview.jpg",
        "coords": [-81.5, 32.5],
        "content": `
<em style="color: #555;">"They voted three times on whether the sky was clear enough to hold the Spring View. By the time it passed, it was nearly dusk. So the first clear day of spring, officially, was held in the dark."</em><br>
<strong style="font-size: 0.9em;">- A merchant from Glenroot, telling the story for the fourth time</strong><br><br>

<h3 style="color: #8B0000; margin-bottom: 5px;">The Village Above the Quiet</h3>
Downsview is what happens when a handful of Southfielders decide they have had enough of wheat, whispering, and dying politely among their sheep. It sits on a cluster of high hills roughly three days off the Quiet Road, reached by a switchback track that punishes carts and rewards walkers. From almost any window in the village, the land falls away into a long sweep of grazing pasture and scrub. On clear days you can see Henon Bay in the distance. On the clearest, the fishing boats. The name does what names should.<br>
The village is barely thirty years old and looks it — tall, narrow houses built tight against the slope, whitewashed walls, painted shutters in whatever color the owner felt like that year, slate roofs angled into the wind. There are no sound-baffles, no padded doors, no heavy curtains. Windows actually open. Older Southfielders visiting for the first time sometimes stand in the main square for a full minute, unsure what to do with the sound of their own footsteps.<br><br>

<h4 style="color: #000080; margin-bottom: 3px;">The Defectors</h4>
Downsview was founded by farmers who walked out on the agricultural interior and by visitors who came for the view and simply never left. The founding families were tired of whispering. Children are allowed to run in the lanes, musicians play outdoors, and arguments happen in full sentences. Neighboring villages send sternly worded letters about once a season, Widow Parns frames the best of them and hangs them behind the bar at her inn. The letters are a point of quiet pride.<br>
Most of Southfield considers the place a mild embarrassment. Downsview, for its part, has been called worse and in fuller voices.<br><br>

<h4 style="color: #000080; margin-bottom: 3px;">The Calendar of Excuses</h4>
The village lives on visitors, and visitors come for festivals. Any excuse will do. There is the Spring View, held on the first clear day of the season by council vote; the Harvest Bleating, which is exactly what it sounds like; the Midsummer Fair, the largest gathering of the year; the Lantern Climb, held in autumn and somehow both dangerous and mandatory; and, most recently, the Livestock Beauty Contest, heading into its fourth year and already responsible for two feuds, one engagement, and one minor stampede. Most locals will happily explain which festival is the real one and why the others were invented by rival families to spite theirs.<br>
Between festivals, the village runs on wool and lodging. The Fletcher Sisters — three spinster weavers who finish each other's sentences and judge everyone who walks into their shop — produce the finest blankets in Southfield. Nearly every household keeps a spare bed or two for travelers; Garrick the blacksmith will rent you the loft above his forge, and Mistress Hennie the baker will rent you the chair by her oven if you ask at the right hour. A single stubborn vegetable farmer supplies the village's greens and insists that the hillside soil is the finest in the region, a claim he will defend with his fists if pressed.<br><br>

<h4 style="color: #000080; margin-bottom: 3px;">Quiet Business</h4>
The mayor is Barnaby Parns, a round, flustered man in a sash half a size too tight, who makes most of the village's official decisions. His mother, Widow Parns, makes most of those. Between them the village runs on a mix of show-of-hands voting and maternal decree, which outsiders sometimes mistake for corruption. The Compact knows Downsview exists, collects its taxes, and otherwise leaves it alone.<br>
At the eastern edge of the village stands the Hollow Chapel, tended by Father Thomas, an aging cleric with kind eyes and a quiet crisis of vocation. Thomas prays daily into the post-Sundering quiet and no longer pretends to hear anything answer. He patches sprains and fevers with what little residue he can draw, and he keeps the village's brief written history in the chapel basement, a collection he has largely forgotten the contents of.<br><br>

<h4 style="color: #000080; margin-bottom: 3px;">Notable Locations</h4>
&bull; <strong>The Lamb & Flag:</strong> Widow Parns' inn and tavern on the main square, and the heart of the village. Low timber beams, a fire that's never allowed to go out, a Shepherd's Pie that's 80% potato, and a strict no-politics rule (sheep genetics excepted).<br>
&bull; <strong>The Chapel:</strong> A drafty old stone chapel at the eastern edge, its bell tower collapsed in a storm years ago and never rebuilt. Father Thomas sells herbal poultices and "blessed rain," and rents out the rectory's spare rooms to the occasional traveler.<br>
&bull; <strong>Hennie's Oven:</strong> Mistress Hennie's bakery, and the village's gossip exchange. Heavy sourdough, honey-cakes, and meat pasties for the field hands. If you want to know who is courting whom, you buy a bun here.<br>
&bull; <strong>The Iron-Shoe:</strong> Garrick's smithy. Smells of hot iron and wet horse. Mostly horseshoes, plowshares, and nails; he can sharpen a sword but will look mildly offended about it. The local farmers loiter here to smoke pipes and complain about the weather.<br>
&bull; <strong>The Spindle & Loom:</strong> The Fletcher Sisters' weaving shop. Three spinning wheels turning in perfect unison, the finest wool blankets in Southfield, and a great deal of silent judgment.<br>
&bull; <strong>The General Ledger:</strong> Mayor Barnaby's office and the village's dry-goods store. Salt, sugar, candles, rope, and a desk piled high with judging forms for the beauty contest. Organized chaos.<br>
&bull; <strong>Krell's Hill Farm:</strong> The largest sheep operation on the lower slopes. Patrolled by a goose. Home to the prize bull. No casual visitors.<br><br>

<h4 style="color: #000080; margin-bottom: 3px;">Plot Hooks</h4>
&bull; <strong>The Fourth Ribbon:</strong> Old Man Krell, the largest sheep farmer on the lower slopes, has won the Livestock Beauty Contest three years running and is paralyzed by the thought of losing the fourth. His prize bull is guarded day and night by two terrified shepherd twins and a goose called Honk, whose hatred is the purest thing in the village. In the tavern, the farmer Jareth — who drinks more than he farms — nurses a plan to humiliate Krell at this year's contest without hurting the bull. He has been describing it loudly to anyone at The Lamb & Flag who will listen, which, according to Widow Parns, is the main reason it hasn't worked yet. Mistress Hennie suspects the bull is being fed something it shouldn't. Barnaby just wants the Grand Parade to end without a fistfight. The party arrives the week of the fair.<br>
&bull; <strong>What's in the Basement:</strong> The two scholars currently lodging at the Hollow Chapel — a dreamy elven minstrel named Liriam and her cynical human partner Corin — are not here for the view. Whatever they are looking for in Father Thomas's forgotten archive, they are not volunteering to explain it, and Thomas has started to notice.<br>
&bull; <strong>Ghost Goblins:</strong> Krell's shepherds keep losing sheep to what they swear are ghosts in the scrub east of the village. The ghosts are goblins. The council would rather not discuss it during festival season.
        `
    },
    "glenroot": {
        "title": "Glenroot",
        "type": "town",
        "image": "assets/Glenroot.jpg",
        "coords": [-80.4, 40.3],
        "content": `
<em style="color: #555;">"The first rule of the Long-Iron is that the handle is fifteen feet long for a reason. The second rule is that fourteen feet is how you lose an apprentice. The third rule is that the head outlasts the handle ten to one. Replace handles every season."</em><br>
<strong style="font-size: 0.9em;">- A Glenroot apprentice's first day of training</strong><br><br>

<h3 style="color: #8B0000; margin-bottom: 5px;">The Quiet Fields</h3>
Glenroot sits on the bank of the Grenset River, one day upstream from Lake Verdane, deep in the conservative interior of Southfield. From a distance it looks like any other riverside village — low stone houses, roofs thatched in thick sound-dampening moss, packed-dirt streets kept deliberately soft underfoot. The pontoon docks are the first thing that gives the place away. They float because the Grenset cannot be trusted to stay at any particular level for long. The second clue is that nobody, not the dockworkers, not the children, not the woman dropping a bucket, makes any sound at all.<br>
This is Southfield at its most observant. Glenroot keeps the silence the way a temple keeps its rites — not from any belief that the crops still need it, since that magic is three generations gone, but because dropping a tool here is a faux pas and raising one's voice is roughly equivalent to throwing a punch. Locals communicate in Field-Sign, a pragmatic dialect of farm-hand gestures, or by writing on slates and chalkboards. Visitors are tolerated; loud visitors are escorted to the village boundary by Captain Bord, who finds the whole business of law enforcement a chore but does it anyway.<br><br>

<h4 style="color: #000080; margin-bottom: 3px;">Anomaly Agriculture</h4>
What makes Glenroot more than another quiet riverside village lies just past its eastern fields. The Patchwork Fields are a grid of farmland crisscrossed by stable temporal anomalies — pockets where the local rate of time has, since some forgotten event, settled into something other than the rest of the world's. The villagers do not pretend to understand them. They farm them.<br>
The Deep-Wait zones are pockets where time crawls at one-tenth the outside rate. Crops inside them take a full decade of external sunlight to grow what a normal field manages in a year, and they soak up the entire ten years of sun, rain, and slow ripening before harvest. The result is dense, complex, and ruinously expensive: Stone-Root turnips so calorie-rich a fist-sized one will feed a family, and grapes that produce wines of impossible vintage inside a single calendar year. Farmers work these pockets from outside, using Long-Irons — hoes and rakes with fifteen-foot handles — and apprentices are taught from their first day to never, ever step inside "just for a moment." An apprentice who slips in to pull a weed for what feels like ten minutes will emerge to find the sun low, his shift over, and his master furious.<br>
The Quick-Step zones run at ten times the outside rate, and the crops there grow furiously without ever absorbing enough nutrients to be worth eating. The result is "water-balloon" produce — radishes the size of melons that taste like wet cardboard, sold in bulk to the Greywater Compact as cheap army rations. Working these fields ages a farmer brutally fast. An hour's labor inside burns through nearly half a day of life; hands gray, joints stiffen, skin peels. The Quick-Steppers wear mechanical clickers called Timer-Canaries to track exposure, and the village's most prominent example of what the work costs is Jory "Spring" Miller, twenty-four years old and prematurely silver, working double shifts to afford something called a Stasis-Bed.<br>
The third zone is the Rot-Bed, a fenced-off patch of accelerated entropy at the village edge. Organic waste dumped there becomes black, fertile soil in hours. It smells of sulfur and aggressive life, and is overseen by "Rotty" Hobb, an oil-skinned compost master with three missing fingers who is, through the careful application of fertilizer fees, one of the wealthiest men in Glenroot.<br>
The Patchwork Fields are also why most outsiders bother making the long quiet trip upriver in the first place. A steady trickle of scholars from the Greywater academies and farther afield comes through Glenroot each year to study how a village of dirt-streaked farmers casually manages, every season, what their archmages can barely sustain in a laboratory: the stable, agricultural exploitation of rift phenomena. The scholars take notes, ask polite questions on slates, and leave more impressed than when they arrived. The villagers tolerate them, charge them inn rates, and have long since stopped finding them interesting.<br><br>

<h4 style="color: #000080; margin-bottom: 3px;">Quiet Business</h4>
Glenroot is governed, technically, by a council of elders, and in practice by Elder Olenna, a stern silver-haired woman in heavy wool shawls who carries a tuning fork on a staff and communicates exclusively through her slate. She maps the borders of the anomalies herself, walking the fields each morning to check whether the Deep-Wait has crept a foot east overnight. Her authority is unquestioned and her patience for outsiders is finite.<br>
Mother Gimm, the village's tiny, clouded-eyed herbalist, treats the Quick-Step farmers when they come in burned. She brews a tea that slows the aging, or claims to, but its primary ingredients grow only in Knotsreach and her supplier has been three months late. Torren "Soft-Hammer" is the blacksmith, a massive man who whispers, wraps his hammer in leather, and forges the village's Long-Irons; he has been trying for years to invent a silent bellows and is, by all accounts, losing.<br><br>

<h4 style="color: #000080; margin-bottom: 3px;">Notable Locations</h4>
&bull; <strong>The Triver Inn:</strong> Mara Triver's bunker of comfort, walls hung with heavy wool tapestries to absorb every sound. Patrons drink alone or play cards in hand-signs. A large slate on the back wall serves as the village square — news, poetry, and grievances are written there rather than spoken. Mara's ward Kip, a scrawny ink-stained sixteen-year-old with a stash of stolen maps and a forbidden interest in the Halcyon League, sweeps the floors and dreams loudly about leaving.<br>
&bull; <strong>The Clay Clock:</strong> A pottery workshop full of dust and silence, run by Elara Clay, a deaf dwarven potter who reads lips perfectly and is, by some margin, the calmest person in town. Her specialty is Stasis-Jars: vessels fired from clay harvested in the Deep-Wait, which retain a faint fragment of the slowed time and preserve food inside them for months. They are her livelihood and, currently, her smuggling operation.<br>
&bull; <strong>The Grenset Docks:</strong> Floating pontoons rising and falling on the Grenset's unreliable currents. The flat-bottomed river-haulers tie up here to load Stasis-Jars for the trip downstream to Lake Verdane. The current senior hauler, Lisbet, has refused to sail at night for two months and will not say what she saw the last time she did.<br>
&bull; <strong>The Long-Iron Forge:</strong> Torren's smithy. Larger than it needs to be to accommodate the fifteen-foot tool handles. The hammer falls are wrapped, the anvil sits on a thick wool pad, and the bellows are still loud enough to make Torren wince every time he pumps them.<br>
&bull; <strong>Mother Gimm's Hut:</strong> A low stone shed at the village edge, smelling of dried sage and bitter tea. Patients lie on a cot inside while Gimm explains, in perfect clinical detail and with no bedside manner whatsoever, exactly how their condition will progress.<br>
&bull; <strong>The Rot-Bed:</strong> A fenced compost pit east of the Patchwork Fields, where the Quick-Step's twin runs in reverse. Hobb runs it. Nobody else willingly stands downwind.<br><br>

<h4 style="color: #000080; margin-bottom: 3px;">Plot Hooks</h4>
&bull; <strong>The Audit:</strong> Silas Vane, a gaunt grey-velvet Compact tax auditor in the late stages of what locals call Silence Sickness, has been camped at the Triver Inn for three weeks and knows the harvest numbers don't add up. The village is producing more Deep-Wait luxury crops than it's reporting. Olenna and Hobb are hiding the surplus in Stasis-Jars buried inside the Rot-Bed, betting Silas is too fastidious to dig through accelerated compost to find them. He has just threatened to summon a Lienhunter squad from Rivhalde if the books aren't balanced by tomorrow. The village is preparing to riot, quietly.<br>
&bull; <strong>The River Thing:</strong> Lisbet has not sailed at night in two months. She will not explain what she saw on the Grenset between Glenroot and Lake Verdane, and the late-evening haulers have started losing cargo and crews. Whatever is out there is getting bolder, and the village's livelihood depends on the route staying open.<br>
&bull; <strong>What Old Kaelen Remembers:</strong> Old Kaelen, a one-legged, one-eyed retired adventurer in his nineties, sits on a bench facing the Rot-Bed every day, muttering about something he calls "The Mire." Locals think he's senile. He has also been trying to remember where, decades ago, he hid an old enchanted sword — and he is getting close. Someone patient enough to listen might learn what The Mire is before whatever's left of it learns about Glenroot.
