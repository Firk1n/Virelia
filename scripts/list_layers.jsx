...
// (Or `python scripts/build_map.py --list --tree`, which does the same thing
// without leaving the terminal.)
//
// Top-level entries are numbered and show the exact name to paste into
// scripts/map_layers.json. Where a name is used twice, the second one is
...
var header = [
    ...
    'into the "show" lists in scripts/map_layers.json.',
    "",
    ""
].join("\n");
